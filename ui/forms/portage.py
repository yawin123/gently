...
class PortageForm(SectionForm):
    ...
    def build_form(self, config: GentlyConfig) -> FormSpec:
        ...
        return FormSpec(
            ...
            fields=[
                ...
                FieldSpec(key="_use_sep", label="form_portage_sep_use",
                          i18n_key="form_portage_sep_use", type="separator", required=False),
                ...
                FieldSpec(key="input_devices", label="INPUT_DEVICES",
                          ...
                          required=False),
                FieldSpec(key="_sources_sep", label="form_portage_sep_sources",
                          i18n_key="form_portage_sep_sources", type="separator", required=False),
                ...
                FieldSpec(key="_binpkg_sep", label="form_portage_sep_binpkg",
                          i18n_key="form_portage_sep_binpkg", type="separator", required=False),
                FieldSpec(key="features", label="FEATURES", i18n_key="form_portage_features_label",
                          type="list", default=list(p.features) if p.features else None,
                          required=False, help="form_portage_features_help"),
                FieldSpec(key="getbinpkg", label="Prefer binary packages",
                          i18n_key="form_portage_getbinpkg_label",
                          type="bool", default=p.getbinpkg or False,
                          required=False, help="form_portage_getbinpkg_help"),
                FieldSpec(key="binpkg_format", label="Binary package format",
                          i18n_key="form_portage_binpkg_format_label",
                          type="choice", default=p.binpkg_format or "",
                          options=["", "gpkg", "xpkg"],
                          required=False, help="form_portage_binpkg_format_help"),
                FieldSpec(key="_profile_sep", label="form_portage_sep_profile",
                          i18n_key="form_portage_sep_profile", type="separator", required=False),
    ...
    def apply(self, config: GentlyConfig, values: dict) -> GentlyConfig:
        ...
        config.portage = PortageConfig(
            ...
            features=values.get("features") or None,
            getbinpkg=values.get("getbinpkg") or None,
            binpkg_format=values.get("binpkg_format") or None,
