...
class Stage3Form(SectionForm):
    ...
    def build_form(self, config: GentlyConfig) -> FormSpec:
        ...
        fields = [
            ...
            FieldSpec(key="_source_sep", label="form_stage3_sep_source",
                      i18n_key="form_stage3_sep_source", type="separator", required=False),
            ...
            FieldSpec(key="_verification_sep", label="form_stage3_sep_verification",
                      i18n_key="form_stage3_sep_verification", type="separator", required=False),
