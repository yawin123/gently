...
class SystemForm(SectionForm):
    ...
    def build_form(self, config: GentlyConfig) -> FormSpec:
        ...
        return FormSpec(
            ...
            subtitle="Hostname, timezone and locale settings",
            fields=[
                FieldSpec(
                    key="hostname",
                    label="Hostname",
                    type="text",
                    default=s.hostname,
                    help="Machine hostname, e.g. myhostbox",
                ),
                FieldSpec(
                    key="timezone",
                    label="Timezone",
                    ...
                    options=_TIMEZONES,
                    help="Full list: ls /usr/share/zoneinfo",
                ),
                FieldSpec(
                    key="locale",
                    label="Locale",
                    ...
                    options=_LOCALES,
                    help="Primary locale (also used in /etc/locale.gen)",
                ),
                FieldSpec(
                    key="locales",
                    label="Extra locales",
                    ...
                    options=_LOCALES,
                    required=False,
                    help="Additional locales to generate (optional)",
                ),
                FieldSpec(
                    key="keymap",
                    label="Keymap",
                ...
                FieldSpec(
                    ...
                    options=_LOCALES,
                    help="Value for the LANG environment variable",
                ),
            ],
        )
